...
Pour les premières étapes : R 
Pour la diffusion : Observable (Javascript) ou Quarto (R + markdown) ou Shiny (R)


### Difficulté  

Débutant pour les premières étapes en R, puis intermédiaire pour la partie diffusion


### Données utilisées

Les données proviennent de [l'enquête agricole de 1852](https://journals.openedition.org/acrh/3696).
...
Il vous suffit d'ouvrir et de modifier le fichier : R/funathon_agriculture_histoire.qmd   
